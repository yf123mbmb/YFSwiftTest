#
# Be sure to run `pod lib lint YFSwiftTest.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'YFSwiftTest'
  s.version          = '0.1.0'
  s.summary          = 'A short description of YFSwiftTest.'
...
TODO: Add long description of the pod here.
  ...
  s.source           = { :git => 'https://github.com/406742790@qq.com/YFSwiftTest.git', :tag => s.version.to_s }
